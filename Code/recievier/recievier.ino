/*  Tutorial here:  http://www.electronoobs.com/eng_arduino_tut86.php
...
with all of them on digital pin D2. Install NRF24 library before you compile
...
{
  ppm[0] = map(data.roll, 0, 255, 1350, 1650);
  ppm[1] = map(data.pitch,      0, 255, 1350, 1650);
  ppm[2] = map(data.throttle,    0, 255, 1000, 2000);
  ppm[3] = map(data.yaw,     0, 255, 1450, 1550);
